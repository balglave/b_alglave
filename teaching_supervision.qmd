...
![](docs/ressource/images/teaching/dag_ssm.png){width=60%}

![](docs/ressource/images/teaching/co2.PNG){width=40%}

![](docs/ressource/images/teaching/semivariogram.png){width=60%}
:::
